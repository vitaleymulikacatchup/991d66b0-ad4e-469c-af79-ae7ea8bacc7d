...
export const metadata: Metadata = {
  title: "Stranger Things Season 5 - The Final Chapter | Netflix",
  description: "Experience the epic conclusion of Stranger Things Season 5. Watch as Eleven and the gang face their ultimate battle against the Upside Down. Stream now on Netflix.",
  keywords: "Stranger Things, Season 5, Netflix, Eleven, Upside Down, Hawkins, Duffer Brothers, final season, supernatural thriller",
  metadataBase: new URL("https://strangerthings-season5.netflix.com"),
  alternates: {
    canonical: "https://strangerthings-season5.netflix.com"
  },
  openGraph: {
    title: "Stranger Things Season 5 - The Final Chapter | Netflix",
    description: "The epic conclusion of Stranger Things arrives. Watch the final season now on Netflix.",
    url: "https://strangerthings-season5.netflix.com",
    siteName: "Stranger Things",
    images: [
      {
        url: "/placeholders/placeholder1.webp",
        alt: "Stranger Things Season 5 official poster"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Stranger Things Season 5 - The Final Chapter",
    description: "The epic conclusion of Stranger Things arrives. Stream the final season now on Netflix.",
